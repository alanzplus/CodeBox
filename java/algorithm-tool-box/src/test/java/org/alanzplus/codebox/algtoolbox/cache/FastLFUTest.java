...
public class FastLFUTest {
  ...
  public void freqNodeTest() throws Exception {
    ...
    FastLFU.CacheNode<String, Integer> cacheNode =
        new FastLFU.CacheNode<>(new FastLFU.FastLFUEntry<>("hello", 1));
  ...
  public void testPromoteCacheNode() throws Exception {
    ...
    FastLFU.CacheNode<String, Integer> cacheNode1 =
        new FastLFU.CacheNode<>(new FastLFU.FastLFUEntry<>("hello", 1)).register(next);
    FastLFU.CacheNode<String, Integer> cacheNode2 =
        new FastLFU.CacheNode<>(new FastLFU.FastLFUEntry<>("world", 2)).register(next);
  ...
  public void testFastLRU() throws Exception {
    ...
    Map<String, FastLFU.CacheNode<String, Integer>> internal =
        ((FastLFU<String, Integer>) cache).cache();
