 ...
 *
 * For example,
 * Object[] values = new Object[KEY_SPACE_SIZE];
 * But for most i in [0, KEY_SPACE_SIZE - 1], values[i] = null
 *
 * How to create a effective data structure?
 */
public interface SparseArray<V> {
  ...
  default long mem() {
    throw new UnsupportedOperationException(
        "mem is not supported by this class " + getClass().getSimpleName());
  }
}
